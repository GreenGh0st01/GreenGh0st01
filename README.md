...
I enjoy building software that solves real problems. My primary focus is backend development, Discord applications, automation, and scalable web services.

I believe good software should be **simple, reliable, maintainable, and fast**.
...
<p align="center">
<img src="https://skillicons.dev/icons?i=js,ts,nodejs,python,nextjs,express,mongodb,postgres,docker,linux,git,github,vscode,html,css,tailwind&perline=8"/>
</p>
...
*"Great software isn't finished when it works—it's finished when people enjoy using it."*
